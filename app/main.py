...
from app.rate_limiter import allow
...
async def normalize_ingredient(request: IngredientRequest, req: Request):
    try:
        ...
        # 4. now we call openAI for normalization -> sends cleaned ingredient to ai
